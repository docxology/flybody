...
class BallFloor(composer.Arena):
    """A floating ball arena for tethered ant walking tasks.""" # Modified docstring
    ...
    def _build(self,
               ...
               skybox=False,
               reflectance=0.2,
               top_camera_y_padding_factor=1.1, # Kept, might not be used by ant runner
               top_camera_distance=100): # Kept, might not be used by ant runner
